...
public class Segment implements Serializable {
    ...
    STRAIGHT_PLATFORM_BELOW, STRAIGHT_PLATFORM_ABOVE, BUMPER_LEFT, BUMPER_RIGHT, SEMAPHORE_TOP, SEMAPHORE_BOTTOM,
        GENERIC_ON_OFF_SWITCH, GENERIC_FUNCTION, STRAIGHT_ROUTE_MARKER, UP_ROUTE_MARKER, SEMAPHORE3_BOTTOM, SEMAPHORE3_TOP, DOWN_ROUTE_MARKER
    };
    ...
    public static final Type[] SEMAPHORE_TYPES = { Type.SEMAPHORE_BOTTOM, Type.SEMAPHORE_TOP,Type.SEMAPHORE3_BOTTOM, Type.SEMAPHORE3_TOP};
    ...
    public static final Type[] ROUTE_TYPES = { Type.STRAIGHT_ROUTE_MARKER, Type.UP_ROUTE_MARKER, Type.DOWN_ROUTE_MARKER,
            Type.SEMAPHORE_BOTTOM, Type.SEMAPHORE_TOP,Type.SEMAPHORE3_BOTTOM, Type.SEMAPHORE3_TOP, Type.BUMPER_LEFT, Type.BUMPER_RIGHT };
